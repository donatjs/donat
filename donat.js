...
datatable={id:'datatable',data:data,rpp:10,page:1,fld:'id,nama'};
...
button:{id:'button',data:data,}, //end button
...
delete:function(){
  ...
  <button onClick="ya();" >${d.svg.icon('check')} Oke</button>
  <button onClick="tutup();" >${d.svg.icon('x')} Cancel</button> </div>
  `;
  d.modal(out);
  ya=function(){
